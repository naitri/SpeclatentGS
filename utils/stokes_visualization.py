...
def polar_vis(s, path,idx, gamma=2.2):
    ...
    plt.imsave(f"{path}/{idx}_intensity.png", intensity, cmap="gray")
    plt.imsave(f"{path}/{idx}_DoP.png", (dop**(1/gamma)).real)
    plt.imsave(f"{path}/{idx}_AoLP.png", (aolp**(1/gamma)).real)
